...
function newProblem() {
    if(currentProblem == 10) {
        ...
        q.innerHTML = currentProblem + '. ' + question[currentProblem-1];
        correctAnswer = answer1[currentProblem-1];
        ...
        document.getElementById("answer" + r1).innerHTML = answer1[currentProblem-1];
        document.getElementById("answer" + r2).innerHTML = answer2[currentProblem-1];
        document.getElementById("answer" + r3).innerHTML = answer3[currentProblem-1];
        document.getElementById("answer" + r4).innerHTML = answer4[currentProblem-1];
    }
